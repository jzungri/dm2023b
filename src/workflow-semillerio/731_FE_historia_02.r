...
PARAM$RandomForest$semilla  <- 127447    # cambiar por la propia semilla
PARAM$RandomForest$splitrule <- "hellinger"

PARAM$CanaritosAsesinos$ratio  <- 2.0        #varia de 0.0 a 2.0, si es 0.0 NO se activan
PARAM$CanaritosAsesinos$desvios  <- 2.03      #desvios estandar de la media, para el cutoff
PARAM$CanaritosAsesinos$semilla  <- 127447   # cambiar por la propia semilla
