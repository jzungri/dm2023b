...
PARAM  <- list()
PARAM$experimento <- "TS741001"

PARAM$exp_input  <- "FE731001"

# me salteo los meses duros de pandemia, pero llego hasta 201907 en training
# entreno en 18 meses

PARAM$future       <- c( 202109 )
PARAM$final_train  <- c( 202107, 202106, 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202006, 202004, 202002, 201912, 201911, 201910 )

PARAM$train$training     <- c( 202105, 202104, 202103, 202102, 202101, 202012, 202011, 202010, 202009, 202008, 202006, 202004, 202002, 201912, 201911, 201910, 201909, 201908 )
...
PARAM$train$semilla  <- 127447  # cambiar por su propia semilla  !!!
