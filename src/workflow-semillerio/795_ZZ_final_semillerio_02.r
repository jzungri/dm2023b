...
PARAM  <- list()
PARAM$experimento  <- "ZZ795002"
PARAM$exp_input  <- "HT751002"
...
PARAM$semillerio  <- 120   # cantidad de semillas a utilizar en el semillerio, podrian ser 50 o 100 para mayor estabilidad
