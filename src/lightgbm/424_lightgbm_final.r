...
PARAM$finalmodel$semilla <- 127447

PARAM$finalmodel$num_iterations <- 225
PARAM$finalmodel$learning_rate <- 0.0269462584790652
PARAM$finalmodel$feature_fraction <- 0.808818275
