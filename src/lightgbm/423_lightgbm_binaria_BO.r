...
PARAM$trainingstrategy$semilla_azar <- 127447 # Aqui poner su  primer  semilla
...
PARAM$hyperparametertuning$semilla_azar <- 127607
#------------------------------------------------------------------------------
...
hs <- makeParamSet(
  ...
  makeIntegerParam("min_gain_to_split", lower = 1L, upper = 15L),
