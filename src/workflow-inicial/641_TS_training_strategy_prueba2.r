...
PARAM$final_train <- c(
  ...
  202101, 202012, 202011, 202010, 202009, 202006, 202005, 202002, 202001,
  201912, 201911, 201910, 201909, 201908
)

PARAM$train$training <- c(
  202103, 202102, 202101,
  202012, 202011, 202010, 202009, 202006, 202005, 202002, 202001, 201912,
  201911, 201910, 201909, 202008, 201907, 201906
)
...
dir.create(paste0("./exp/", PARAM$experimento, "/prueba2/"), showWarnings = FALSE)
# Establezco el Working Directory DEL EXPERIMENTO
setwd(paste0("./exp/", PARAM$experimento, "/prueba2/"))
